// Main JavaScript file for E-Mark Media website
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.service-card, .product-card, .company-text, .clients-logos');
    ...
    backToTopBtn.style.cssText = `
        ...
        z-index: 999;
        box-shadow: 0 4px 12px rgba(217, 77, 66, 0.4);
    `;
    ...
    console.log('E-Mark Media website loaded successfully');
});
